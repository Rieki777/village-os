-- 0205: what one member says they need, and how they are doing on it. (R20; lane N4)
--
...
--
-- 0204 carries the TARGET: `village_needs` is what the village said it is for.
...
--
-- NO FOREIGN KEYS. This schema has zero of them on purpose, the same as 0204.
