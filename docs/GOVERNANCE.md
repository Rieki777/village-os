...
It describes the code at commit `3ea034684ad484bcd00745088579f50436e05ed5`.
...
```json
{
  "commit": "3ea034684ad484bcd00745088579f50436e05ed5",
  "module": {
    "id": "governance",
    "shipsAs": "off",
    "lifecycles": [
...
Checked against the 143 migration files in `drizzle/`.
